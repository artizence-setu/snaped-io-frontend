    ...
    <div className="flex flex-col md:flex-row w-full gap-8 px-4 sm:px-6 md:px-8 lg:px-20 py-12 lg:py-20 bg-custom-gradient2">
      <div className="w-full md:w-2/4 pt-6">
        ...
        >
          ...
          few clicks! Simply input your script or text, and let our AI generate
          a fully animated video complete with visuals, voiceovers, and
          captions. It's the easiest way to bring your ideas to life without
          needing any video production skills.
        </p>
      </div>
