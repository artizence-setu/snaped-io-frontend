...
export default function VideoGeneration({ text, language, audioUrl, selectedVoiceAnchor , setVideoUrl }: VideoGenerationProps) {
  ...
  const handleGenerateVideo = async () => {
    if (!text || !language || !audioUrl || !selectedVoiceAnchor) {
        console.log(text , language , audioUrl , selectedVoiceAnchor)
        toast.error("Please generate sound before generating the video.");
